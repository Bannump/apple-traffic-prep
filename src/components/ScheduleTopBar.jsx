...
export function ScheduleTopBar({ view, currentDay, onSelectDay, completed }) {
    ...
    <header className="schedule-top">
      ...
      {showDayNav && (
        <div className="schedule-top-row">
          <nav className="day-nav day-nav-horizontal" aria-label="Day schedule">
          ...
          <div className="overall-progress overall-progress-inline">
